# CraftedHippo - A Modern Fullstack E-Commerce Marketplace for Digital Products
...
try {
    ...
    from: 'CraftedHippo <hello@joshtriedcoding.com>',
    to: [user.email],
...
<Html>
    <Head />
    <Preview>Your CraftedHippo Receipt</Preview>
    ...
    <Container style={container}>
        ...
        Copyright © 2023 CraftedHippo Inc. <br />{' '}
...
<Body style={main}>
    ...
    <Text style={paragraph}>
        Welcome to CraftedHippo, the marketplace for high quality digital
...
export function constructMetadata({
  title = 'CraftedHippo - the marketplace for digital assets',
  description = 'CraftedHippo is an open-source marketplace for high-quality digital goods.',
  image = '/thumbnail.png',
  icons = '/favicon.ico',
  noIndex = false,
}: {
  ...
  return {
    ...
    icons,
    metadataBase: new URL('https://craftedhippo.up.railway.app'),
    ...(noIndex && {
      robots: {
        index: false,
        follow: false,
